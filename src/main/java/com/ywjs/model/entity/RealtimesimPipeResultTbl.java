...
public class RealtimesimPipeResultTbl extends RealtimesimPipeResultTblKey {
    ...
    public RealtimesimPipeResultTbl(Integer simulationidRealsimall, String pipenameSimpiperes, Double mileageSimpiperes, String pipeidSimpiperes, Double elevationSimpiperes, Double temperatureSimpiperes, Double pressureSimpiperes, Double flowSimpiperes, Double liquidSimpiperes, Double flowrateSimpiperes, Double gasheatSimpiperes, Double liquidheatSimpiperes, Double gasdensitySimpiperes, Double liquiddensitySimpiperes) {
        super(simulationidRealsimall, pipenameSimpiperes, mileageSimpiperes);
    ...
    public RealtimesimPipeResultTbl() {
        super();
    }

...
import pandas as pd
import os.path
filename = os.path.join(os.path.dirname(__file__), "D:/develop/PG-Pipe/pipe_servers/createfile/pipsfile/2019-12-15 12-38-34-151-model.pips")
...
model.save("D:/develop/PG-Pipe/pipe_servers/createfile/pipsfile/2019-12-15 12-38-34-151-model.pips")
